...
function Navbar() {
  ...
  return (
    <div>
      ...
      <p className="p-5 text-3xl font-bold text-[#008036]">Truckable</p>
        {/* <Image
          src={Logo}
          style={{ zIndex: 40 }}
          layoutId="main-image"
        ...
        <ul className=" menu lg:menu-horizontal hidden ">
          <li tabIndex="0">
            ...
            <Link href="technology">Logout</Link>
            </a>
          </li>
        </ul>
        <label
      ...
      <div
        className={` absolute  px-5 bg-white py-10 z-50 transition-all duration-500 w-[100vw] lg:hidden ${
